# SwiftOS OTA repo
In order for a device to be officially supported, OTA information needs to be added.
  ...
  "response": [
    {
        ...
        "oem": "OEM",
        "device": "Device Name",
        "filename": "SwiftOS-1.0-<date>-<device codename>-v<crversion>.zip",
        "download": "https://sourceforge.net/projects/swiftos/files/<device codename>/<crversion>/SwiftOS-1.0-<date>-<device codename>-v<crversion>.zip/download",
...
### 3.1 Initial support ###
After you contacted [TTTT55 on Telegram](https://telegram.me/TTTT55), and have the approval, follow the below steps.
...
```
git clone git@github.com:swiftos/android_vendor_swiftOTA.git -b u
```
2. Change to the directory where you cloned this repo (android_vendor_swiftOTA) and fetch updates from repo.
```
